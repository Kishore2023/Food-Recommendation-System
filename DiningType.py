...
tfidf_matrix = tfidf.fit_transform(anime['DiningType'])
tfidf_matrix1 = tfidf.fit_transform(anime['DiningType'])
tfidf_matrix2 = tfidf.fit_transform(anime['DiningType'])
tfidf_matrix.shape 
...
pickle.dump(anime, open('DiningType.pkl','wb'))

anime["DiningType"].values
