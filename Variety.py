...
tfidf_matrix = tfidf.fit_transform(anime['Variety'])
tfidf_matrix1 = tfidf.fit_transform(anime['Variety'])
tfidf_matrix2 = tfidf.fit_transform(anime['Variety'])
tfidf_matrix.shape 
...
pickle.dump(anime, open('Variety.pkl','wb'))

anime["Variety"].values
